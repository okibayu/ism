                ...
                <form id="bookingFlight" method="post">
                  ...
                  <div className="form-row">
                    ...
                    <div className="col-md-6 col-lg-6 travellers-class form-group">
                      <input type="text" id="flightTravellersClass" className="travellers-class-input form-control" name="flight-travellers-class" placeholder="Travellers, Class" readOnly required OnClick="return false;" />
              ...
              <div className="bg-light">
                ...
                <form id="bookingTrain" method="post">
                  ...
                  <div className="form-row">
                    ...
                    <div className="col-md-6 col-lg-6 travellers-class form-group">
                      <input type="text" id="trainTravellersClass" className="travellers-class-input form-control" name="train-travellers-class" placeholder="Travellers, Class" readOnly required onkeypress="return false;" />
                      <span className="icon-inside"><i className="fas fa-caret-down" /></span>
                      <div className="travellers-dropdown">
                        <div className="row align-items-center">
                          <div className="col-sm-7">
...
class Referer extends React.Component {
  render() {
    ...
    <div className="text-light shadow-md"
      style={{
